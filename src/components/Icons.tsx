  ...
  return (
    <svg
      ...
      <g stroke="currentColor" strokeWidth="2" strokeLinecap="round">
        <path d="M10 6V2" opacity="1" />
        <path d="M12 6.536 14 3.072" opacity="0.9" />
        <path d="M13.464 8l3.464-2" opacity="0.8" />
        <path d="M14 10h4" opacity="0.7" />
        <path d="M13.464 12l3.464 2" opacity="0.6" />
        <path d="M12 13.464 14 16.928" opacity="0.5" />
        <path d="M10 14v4" opacity="0.4" />
        <path d="M8 13.464 6 16.928" opacity="0.35" />
        <path d="M6.536 12l-3.464 2" opacity="0.3" />
        <path d="M6 10H2" opacity="0.25" />
        <path d="M6.536 8 3.072 6" opacity="0.2" />
        <path d="M8 6.536 6 3.072" opacity="0.15" />
      </g>
    </svg>
  );
}
